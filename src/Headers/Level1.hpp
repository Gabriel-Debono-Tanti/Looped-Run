...
void Level1::Init(sf::RenderWindow& window)
{ 
      music.setLoopPoints({sf::milliseconds(0), sf::seconds(38)});
        music.play();
        
  tmp.Init("Levels/Level1.json", "Textures/tilemap.png", Vector2i(60, 34), Vector2i(32, 32), Vector2i(2048, 2048));
  tiles = tmp.Layer();
...
inline void Level1::Events(sf::RenderWindow& window, const optional<Event>& event)
{ 
